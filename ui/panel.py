...
class Ui_IDAngrPanel(object):
    def setupUi(self, IDAngrPanel):
        ...
        self.stdinBox = QtWidgets.QCheckBox(self.widget)
        self.stdinBox.setEnabled(False)
        self.stdinBox.setGeometry(QtCore.QRect(530, 10, 211, 38))
        self.stdinBox.setObjectName("stdinBox")
        self.viewStdinBtn = QtWidgets.QPushButton(self.widget)
        self.viewStdinBtn.setEnabled(False)
        self.viewStdinBtn.setGeometry(QtCore.QRect(730, 10, 161, 45))
        ...
        self.hexMemBox.setEnabled(False)
    ...
    def retranslateUi(self, IDAngrPanel):
        ...
        self.stdinBox.setText(_translate("IDAngrPanel", "Symbolic stdin"))
