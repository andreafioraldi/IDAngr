...
class Ui_IDAngrPanel(object):
    def setupUi(self, IDAngrPanel):
        ...
        self.viewStdinBtn = QtWidgets.QPushButton(self.widget)
        self.viewStdinBtn.setEnabled(False)
        self.viewStdinBtn.setGeometry(QtCore.QRect(470, 10, 161, 45))
        self.viewStdinBtn.setObjectName("viewStdinBtn")
        self.viewStdoutBtn = QtWidgets.QPushButton(self.widget)
        self.viewStdoutBtn.setEnabled(False)
        self.viewStdoutBtn.setGeometry(QtCore.QRect(640, 10, 161, 45))
        self.viewStdoutBtn.setObjectName("viewStdoutBtn")
        self.viewStderrBtn = QtWidgets.QPushButton(self.widget)
        self.viewStderrBtn.setEnabled(False)
        self.viewStderrBtn.setGeometry(QtCore.QRect(810, 10, 161, 45))
        self.viewStderrBtn.setObjectName("viewStderrBtn")
    ...
    def retranslateUi(self, IDAngrPanel):
        ...
        self.viewStdinBtn.setText(_translate("IDAngrPanel", "View Stdin"))
        self.viewStdoutBtn.setText(_translate("IDAngrPanel", "View Stdout"))
        self.viewStderrBtn.setText(_translate("IDAngrPanel", "View Stderr"))
