...
from context import load_project, get_memory_type, SIMPROCS_FROM_CLE, ONLY_GOT_FROM_CLE, TEXT_GOT_FROM_CLE
import idaapi
import idc
...
class SimIdaMemory(object):
    ...
    def _initialize_page(self, n, new_page):
        ...
        if get_memory_type() == TEXT_GOT_FROM_CLE or (get_memory_type() == ONLY_GOT_FROM_CLE and seg == idaapi.get_segm_by_name(project.arch.got_section_name)): #yes this is weird
