...
def register(conn):
    if conn:
        conn[0].modules.angrdbg.register_debugger(IdaDebugger(conn[0].modules.angrdbg))
        conn[1].modules.angrdbg.register_debugger(IdaDebugger(conn[1].modules.angrdbg))
    else:
        get_angrdbg().register_debugger(IdaDebugger(get_angrdbg()))
