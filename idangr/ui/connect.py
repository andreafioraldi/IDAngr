...
class Ui_IDAngrConnectDialog(object):
    def setupUi(self, IDAngrConnectDialog):
        ...
        self.pinBox = QtWidgets.QCheckBox(IDAngrConnectDialog)
        self.pinBox.setObjectName("pinBox")
        self.gridLayout.addWidget(self.pinBox, 7, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.saveBox, 6, 0, 1, 1)
    ...
    def retranslateUi(self, IDAngrConnectDialog):
        ...
        self.pinBox.setText(_translate("IDAngrConnectDialog", "I\'m attached to Intel Pin"))
