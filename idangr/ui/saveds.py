...
class Ui_IDAngrSavedsDialog(object):
    def setupUi(self, IDAngrSavedsDialog):
        ...
        self.buttonBox.setGeometry(QtCore.QRect(-220, 530, 1141, 41))
        ...
        self.selectorList.setGeometry(QtCore.QRect(10, 20, 271, 501))
        ...
        self.codeView.setGeometry(QtCore.QRect(290, 20, 641, 501))
